...
export default function WorkView() {
  return (
    <section id="work" className="px-4 pt-24">
      <div className="flex mb-4 justify-end">
        <h5 className="text-xl uppercase">
          [{String(projects.length).padStart(2, "0")}]
        </h5>

        <h1 className="text-7xl font-sans uppercase">Selected Works</h1>
      </div>

      <div className="w-full border border-foreground/70 grid grid-cols-3 divide-x divide-y divide-foreground/70">
